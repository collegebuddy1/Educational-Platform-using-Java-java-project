 ...
 * @author Ali
 */
public class AssignmentSubFrame extends javax.swing.JFrame {
...
Date CurrentDate= new Date(); // Current System Date and time is assigned to objDate
 ...
 FileWrite("MohamedHassanDeadline1.txt",objSDF.format(CurrentDate));
...
outputStream.close();
    ...
    private void initComponents() {
        ...
        jButtonh3.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jLabel3.setText("9:05:39 PM 14-Jun-2022");
...
//Open Button
    ...
    private void jButtonh3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonh3ActionPerformed
        FileWrite("MohamedHassanAssignmentPath1.txt",path);
        try {
            DeadlineCheck();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            File file_path = new File("sheet #1.pdf");
            if(file_path.exists()){
            if(Desktop.isDesktopSupported()){
            Desktop.getDesktop().open(file_path);
            }
